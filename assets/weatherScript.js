	...
	if (userInput == "") {
		...
		$.ajax({
            ...
            day.forEach(function (i) {
                ...
                forecastList.append("<div class='fiveDayColor' style='background-color: rgb(195, 235, 241); padding: 2ch;'>" + "<h2>" + fiveDayForecast + "</h2>" + "<p>" + "Forecast: " + response.list[i].weather[0].description + "</p>" + "<p>" + "Temperature: " + response.list[i].main.temp + "</p>" + "<p>" + "Humidity: " + response.list[i].main.humidity + "%" + "</p>" + "</div>");
